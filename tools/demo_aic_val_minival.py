...
if __name__ == '__main__':
    ...
    xmaxarr=[]
    ymaxarr=[]
    results = open("aic-val-minival/test-dev_images.txt", 'w')
    score_file = open("aic-val-minival/score-proposals.txt",'w')
    index_file = open("aic-val-minival/index.txt",'w')
    num_boxes = 0
    ...
    with h5py.File('aic-val-minival/test-dev.h5', 'w') as hf:
