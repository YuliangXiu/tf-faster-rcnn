...
if __name__ == '__main__':
    ...
    xmaxarr=[]
    ymaxarr=[]
    results = open("aic-test-a/test-dev_images.txt", 'w')
    score_file = open("aic-test-a/score-proposals.txt",'w')
    index_file = open("aic-test-a/index.txt",'w')
    num_boxes = 0
    ...
    with h5py.File('aic-test-a/test-dev.h5', 'w') as hf:
