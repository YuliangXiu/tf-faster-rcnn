...
NETS = {'vgg16': ('vgg16_faster_rcnn_iter_70000.ckpt',),'res101': ('res101_faster_rcnn_iter_110000.ckpt',),'res152':('res152_faster_rcnn_iter_490000_5scale.ckpt',)}
...
if __name__ == '__main__':
    ...
    im_names = [line.rstrip('\n') .rstrip('\r') for line in open("../data/aic-val-minival.txt")]
    ...
    xmaxarr=[]
    ymaxarr=[]
    results = open("aic-val-minival-2/test-dev_images.txt", 'w')
    score_file = open("aic-val-minival-2/score-proposals.txt",'w')
    index_file = open("aic-val-minival-2/index.txt",'w')
    num_boxes = 0
    ...
    with h5py.File('aic-val-minival-2/test-dev.h5', 'w') as hf:
