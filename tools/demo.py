...
if __name__ == '__main__':
    ...
    im_names = [line.rstrip('\n') .rstrip('\r') for line in open("../data/coco-minival_images-500.txt")]
    ...
    xmaxarr=[]
    ymaxarr=[]
    results = open("coco-minival-images-newnms/test-dev_images.txt", 'w')
    score_file = open("coco-minival-images-newnms/score-proposals.txt",'w')
    index_file = open("coco-minival-images-newnms/index.txt",'w')
    num_boxes = 0
    ...
    with h5py.File('coco-minival-images-newnms/test-dev.h5', 'w') as hf:
