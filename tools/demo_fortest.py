...
if __name__ == '__main__':
    ...
    im_names = [line.rstrip('\n') .rstrip('\r') for line in open("../data/test2015-quanji.txt")]
    ...
    xmaxarr=[]
    ymaxarr=[]
    results = open("coco-test-newnms/test-dev_images.txt", 'w')
    score_file = open("coco-test-newnms/score-proposals.txt",'w')
    index_file = open("coco-test-newnms/index.txt",'w')
    num_boxes = 0
    ...
    with h5py.File('coco-test-newnms/test-dev.h5', 'w') as hf:
