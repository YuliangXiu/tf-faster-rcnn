...
if __name__ == '__main__':
    ...
    im_names = [line.rstrip('\n') .rstrip('\r') for line in open("../data/kibr/trainvalName.txt")]
    ...
    xmaxarr=[]
    ymaxarr=[]
    results = open("trainval/test-dev_images.txt", 'w')
    score_file = open("trainval/score-proposals.txt",'w')
    index_file = open("trainval/index.txt",'w')
    num_boxes = 0
    for im_name in im_names:
        print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
        print('Demo for data/coco/{}'.format(im_name))
        num_boxes=demo(sess, net, im_name,xminarr,yminarr,xmaxarr,ymaxarr,results,score_file,index_file,num_boxes)
    with h5py.File('trainval/test-dev.h5', 'w') as hf:
